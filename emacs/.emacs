...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (quelpa yaml-mode helm irony company-anaconda racer company toml-mode rust-mode elixir-mode zeal-at-point xcscope projectile list-register idle-highlight-mode highlight-symbol highlight-parentheses etags-select dired+ counsel browse-kill-ring))))
(custom-set-faces
